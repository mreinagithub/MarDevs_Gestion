...
namespace MarDevs.Gestion.Win
{
	public static class App
	{
		...
		public static void CrearToolsSeguimiento(PopupMenuTool popupPadre, bool crearNuevoGrupo)
		{
			...
			nuevoBoton.SharedProps.AppearancesSmall.Appearance.Image = MarDevs.Gestion.Win.Properties.Resources.ImagenSeguimiento;
			...
			nuevoBoton.SharedProps.AppearancesSmall.Appearance.Image = MarDevs.Gestion.Win.Properties.Resources.ImagenAviso;
		...
		public static object TraerRecurso(string nombreRecurso)
		{
			...
			object recurso = MarDevs.Gestion.Win.Properties.Resources.ResourceManager.GetObject(nombreRecurso);
			if (recurso == null)
			{

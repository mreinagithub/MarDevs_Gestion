...
namespace MarDevs.Gestion.Win
{
	public partial class FormVistaPersonalizada : Form
	{
		...
		private void grillaPermisos_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
			...
			vli1.Appearance.Image = MarDevs.Gestion.Win.Properties.Resources.ImagenRol;
			...
			vli2.Appearance.Image = MarDevs.Gestion.Win.Properties.Resources.ImagenUsuario;
		...
		{
			var query = System.Reflection.Assembly.Load("MarDevs.Gestion.Core").GetTypes().Where(t => t.IsEnum);
		...
		{
			System.Resources.ResourceSet temp = MarDevs.Gestion.Win.Properties.Resources.ResourceManager.GetResourceSet(System.Globalization.CultureInfo.InvariantCulture, false, false);

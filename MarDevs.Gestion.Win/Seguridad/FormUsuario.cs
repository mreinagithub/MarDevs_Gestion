...
namespace MarDevs.Gestion.Win
{
	public partial class FormUsuario : EditorBase
	{
		...
		{
			this.Icon = MarDevs.Gestion.Win.Properties.Resources.IconoUsuario;
			...
			else
			{
				...
				Alcances privModificar = ConfigBL.ticket.TienePrivilegio((int)MarDevs.Gestion.Core.PRV.ADMINISTRAR_USUARIO);

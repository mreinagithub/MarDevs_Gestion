...
namespace MarDevs.OC.Win
{
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.controlSeguimiento1 = new MarDevs.OC.Win.ControlSeguimiento();
            this.panel1 = new System.Windows.Forms.Panel();
            this.panelNavegacionUserControl1 = new MarDevs.OC.Win.PanelNavegacionUserControl();
            ...
            this.autoUpdater1 = new MarDevs.OC.Win.AutoUpdater();
            ...
            this.panelNavegacionUserControl1.ComandoEjecutado += new MarDevs.OC.Win.ComandoEjecutadoEventHandler(this.panelNavegacionUserControl1_ComandoEjecutado);
            // 
        ...
        private void Form1_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				//REGISTRAR RECURSOS
				Recursos.AgregarEnsamblado(Assembly.GetEntryAssembly(), "MarDevs.OC.Win.Properties.Resources");
				Assembly ass = Assembly.GetAssembly(typeof(MarDevs.OC.Win.FormLogin));
				Recursos.AgregarEnsamblado(ass, "MarDevs.OC.Win.Properties.Resources");
				//CREAR MENU PRINCIPAL Y PANEL DE NAVEGACION.				
				CrearMenuPrincipal();
				SetearTituloAplicacion();
				EstablecerModoMDI(MarDevs.OC.Win.Properties.Settings.Default.MultiVentana);
				CachearMenuFiltrosTextoGrilla();
				Splash.Cerrar(false);
				this.WindowState = (MarDevs.OC.Win.Properties.Settings.Default.AppMaximizada == true) ? FormWindowState.Maximized : FormWindowState.Normal;
		...
		private void CrearMenuPrincipal()
		{
			...
			PanelNavegacion panel = PanelNavegacion.ObtenerDesdeRecursoIncrustado("panel-navegacion.xml, OC");
			...
			//comando.Target = "MarDevs.OC.Win.FormPedidoRepuesto, OC";
			...
			//	comando.Target = "MarDevs.OC.Win.FormListaPedidoRepuesto, OC";
		...
		private void MostrarPreferencias()
		{
			...
			if (MarDevs.OC.Win.Properties.Settings.Default.MultiVentana != _multiFormulario)
				EstablecerModoMDI(MarDevs.OC.Win.Properties.Settings.Default.MultiVentana);
		}
		...
		{
			MarDevs.OC.Win.Properties.Settings.Default.UltimoUsuarioLogueado = ConfigBL.ticket.Usuario.Logon;
			MarDevs.OC.Win.Properties.Settings.Default.MultiVentana = _multiFormulario;
			MarDevs.OC.Win.Properties.Settings.Default.AppMaximizada = (this.WindowState == FormWindowState.Maximized);
			MarDevs.OC.Win.Properties.Settings.Default.UltimoPanelActivo = panelNavegacionUserControl1.UltraExplorerBar1.SelectedGroup.Key;
			MarDevs.OC.Win.Properties.Settings.Default.Save();
		}

	...
	public partial class FormPreferencias : Form
	{
		...
		private void FormPreferencias_Load(object sender, EventArgs e)
		{
			try
			{
				...
				this.checkUsarMultiFormulario.Checked = MarDevs.OC.Win.Properties.Settings.Default.MultiVentana;
		...
		private void aceptarButton_Click(object sender, EventArgs e)
		{
			try
			{
				MarDevs.OC.Win.Properties.Settings.Default.MultiVentana = checkUsarMultiFormulario.Checked;
